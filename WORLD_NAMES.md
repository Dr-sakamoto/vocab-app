...
「特定の人気者を応援する応援団」。組織名・応援先の名称は未確定。

| 内部ID | 現行（参考） | 所在地（現行・参考） | 新設定 | status | memo |
|---|---|---|---|---|---|
| （組織名） | ロケット団 | — | 応援団（名称未定） | pending | |
| （応援先本人） | サカキ | — | 推しキャラ（名称未定） | pending | 上表 giovanni-1/2/3 のサカキと同一人物設定。「ZONE関門」側に置くか「応援団の推し」側に置くか、役割の重複を整理する必要あり |
| rocket-mt-moon | ムサシ＆コジロウ | おつきみやま | 応援団メンバー | pending | |
| rocket-scout | ロケット団スカウト員 | 24ばんどうろ | 応援団メンバー | pending | |
| rocket-thief | 泥棒ロケット団員 | ハナダシティ | 応援団メンバー | pending | 「泥棒」という役柄は犯罪組織前提のため要再設定 |
| rocket-celadon | ムサシ＆コジロウ | タマムシ地下アジト | 応援団メンバー | pending | 拠点（地下アジト）も要再設定。§3の「タマムシ地下アジト」参照 |
| giovanni-1 | サカキ | タマムシ地下アジト | 推しキャラ or 応援団リーダー | pending | |
| rocket-tower | ロケット団員 | エティモンタワー最上階 | 応援団メンバー | pending | |
| rocket-silph | ムサシ＆コジロウ | シルフカンパニー11かい | 応援団メンバー | pending | 「企業占拠」プロットの代替が必要（§3参照） |
| giovanni-2 | サカキ | シルフカンパニー社長室 | 推しキャラ or 応援団リーダー | pending | |
