...
function isAlternativeMatch(userAnalysis, answerAnalysis) {
  ...
  if (userAnalysis.readingKey === answerAnalysis.readingKey) return true;
  if (userAnalysis.normalized === answerAnalysis.readingKey) return true;
  if (answerAnalysis.normalized === userAnalysis.readingKey) return true;
