...
export const MONSTER_LINES = [
  ...
  // 据え置き（アートはP3で差替予定のプレースホルダ）。名前のみ IP_STARTERS.md に反映。
  {
    ...
    name: "ウタちゃん",
    species: [
      species({ id: 1, name: "ウタちゃん", nameEn: "Voxel", minLevel: 1, maxLevel: 15 }),
      species({ id: 2, name: "ウタもん", nameEn: "Invokra", minLevel: 16, maxLevel: 31 }),
      species({ id: 3, name: "ウタどん", nameEn: "Vocarch", minLevel: 32 }),
    ],
  },
  {
    // PORT 系：支える／届ける
    ...
    name: "モチくん",
    species: [
      species({ id: 4, name: "モチくん", nameEn: "Portling", minLevel: 1, maxLevel: 15 }),
      species({ id: 5, name: "モチもん", nameEn: "Transpord", minLevel: 16, maxLevel: 35 }),
      species({ id: 6, name: "モチどん", nameEn: "Portarch", minLevel: 36 }),
    ],
  },
  {
    // SPEC 系：気づき／まなざし
    ...
    name: "ミルくん",
    species: [
      species({ id: 7, name: "ミルくん", nameEn: "Speculet", minLevel: 1, maxLevel: 15 }),
      species({ id: 8, name: "ミルもん", nameEn: "Inspex", minLevel: 16, maxLevel: 35 }),
      species({ id: 9, name: "ミルどん", nameEn: "Spectarch", minLevel: 36 }),
    ],
  },
  {
    id: "caterpie",
