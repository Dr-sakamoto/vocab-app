...
export const MONSTER_LINES = [
  ...
  // 据え置き（アートはP3で差替予定のプレースホルダ）。名前のみ IP_STARTERS.md に反映。
  {
    ...
    name: "カタコト",
    species: [
      species({ id: 1, name: "カタコト", nameEn: "Dictling", minLevel: 1, maxLevel: 24 }),
  ...
  },
  {
    ...
    name: "ミミタテ",
    species: [
      species({ id: 4, name: "ミミタテ", nameEn: "Audling", minLevel: 1, maxLevel: 24 }),
  ...
  },
  {
    ...
    species: [
      ...
      species({ id: 9, name: "ミトオシ", nameEn: "Spectarch", minLevel: 25 }),
    ],
  },
  {
    id: "caterpie",
