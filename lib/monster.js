...
export const MONSTER_LINES = [
  ...
  },
  {
    ...
    name: "Caterpie",
    species: [
      species({ id: 10, name: "Caterpie", nameEn: "Caterpie", minLevel: 1, maxLevel: 6 }),
      species({ id: 11, name: "Metapod", nameEn: "Metapod", minLevel: 7, maxLevel: 9 }),
      species({ id: 12, name: "Butterfree", nameEn: "Butterfree", minLevel: 10 }),
    ],
  },
  {
    id: "weedle",
    name: "Weedle",
    species: [
      species({ id: 13, name: "Weedle", nameEn: "Weedle", minLevel: 1, maxLevel: 6 }),
      species({ id: 14, name: "Kakuna", nameEn: "Kakuna", minLevel: 7, maxLevel: 9 }),
      species({ id: 15, name: "Beedrill", nameEn: "Beedrill", minLevel: 10 }),
    ],
  },
  {
    id: "pikachu",
    name: "Pikachu",
    species: [
      species({ id: 25, name: "Pikachu", nameEn: "Pikachu", minLevel: 1, maxLevel: 98 }),
      species({ id: 26, name: "Raichu", nameEn: "Raichu", minLevel: 99 }),
    ],
  },
  {
    id: "spearow",
    name: "Spearow",
    species: [
      species({ id: 21, name: "Spearow", nameEn: "Spearow", minLevel: 1, maxLevel: 19 }),
      species({ id: 22, name: "Fearow", nameEn: "Fearow", minLevel: 20 }),
    ],
  },
  {
    id: "mankey",
    name: "Mankey",
    species: [
      species({ id: 56, name: "Mankey", nameEn: "Mankey", minLevel: 1, maxLevel: 27 }),
      species({ id: 57, name: "Primeape", nameEn: "Primeape", minLevel: 28 }),
    ],
  },
  {
    id: "nidoran-f",
    name: "Nidoran F",
    species: [
      species({ id: 29, name: "Nidoran F", nameEn: "Nidoran F", minLevel: 1, maxLevel: 15 }),
      species({ id: 30, name: "Nidorina", nameEn: "Nidorina", minLevel: 16, maxLevel: 98 }),
      species({ id: 31, name: "Nidoqueen", nameEn: "Nidoqueen", minLevel: 99 }),
    ],
  },
  {
    id: "nidoran-m",
    name: "Nidoran M",
    species: [
      species({ id: 32, name: "Nidoran M", nameEn: "Nidoran M", minLevel: 1, maxLevel: 15 }),
      species({ id: 33, name: "Nidorino", nameEn: "Nidorino", minLevel: 16, maxLevel: 98 }),
      species({ id: 34, name: "Nidoking", nameEn: "Nidoking", minLevel: 99 }),
    ],
  },
  {
    id: "jigglypuff",
    name: "Jigglypuff",
    species: [
      species({ id: 39, name: "Jigglypuff", nameEn: "Jigglypuff", minLevel: 1, maxLevel: 98 }),
      species({ id: 40, name: "Wigglytuff", nameEn: "Wigglytuff", minLevel: 99 }),
    ],
  },
  {
    id: "zubat",
    name: "Zubat",
    species: [
      species({ id: 41, name: "Zubat", nameEn: "Zubat", minLevel: 1, maxLevel: 21 }),
      species({ id: 42, name: "Golbat", nameEn: "Golbat", minLevel: 22 }),
    ],
  },
  {
    id: "geodude",
    name: "Geodude",
    species: [
      species({ id: 74, name: "Geodude", nameEn: "Geodude", minLevel: 1, maxLevel: 24 }),
      species({ id: 75, name: "Graveler", nameEn: "Graveler", minLevel: 25, maxLevel: 98 }),
      species({ id: 76, name: "Golem", nameEn: "Golem", minLevel: 99 }),
    ],
  },
  {
    id: "paras",
    name: "Paras",
    species: [
      species({ id: 46, name: "Paras", nameEn: "Paras", minLevel: 1, maxLevel: 23 }),
      species({ id: 47, name: "Parasect", nameEn: "Parasect", minLevel: 24 }),
    ],
  },
  {
    id: "clefairy",
    name: "Clefairy",
    species: [
      species({ id: 35, name: "Clefairy", nameEn: "Clefairy", minLevel: 1, maxLevel: 98 }),
      species({ id: 36, name: "Clefable", nameEn: "Clefable", minLevel: 99 }),
    ],
  },
  {
    id: "ekans",
    name: "Ekans",
    species: [
      species({ id: 23, name: "Ekans", nameEn: "Ekans", minLevel: 1, maxLevel: 21 }),
      species({ id: 24, name: "Arbok", nameEn: "Arbok", minLevel: 22 }),
    ],
  },
  {
    id: "sandshrew",
    name: "Sandshrew",
    species: [
      species({ id: 27, name: "Sandshrew", nameEn: "Sandshrew", minLevel: 1, maxLevel: 21 }),
      species({ id: 28, name: "Sandslash", nameEn: "Sandslash", minLevel: 22 }),
    ],
  },
  {
    id: "oddish",
    name: "Oddish",
    species: [
      species({ id: 43, name: "Oddish", nameEn: "Oddish", minLevel: 1, maxLevel: 20 }),
      species({ id: 44, name: "Gloom", nameEn: "Gloom", minLevel: 21, maxLevel: 98 }),
      species({ id: 45, name: "Vileplume", nameEn: "Vileplume", minLevel: 99 }),
    ],
  },
  {
    id: "bellsprout",
    name: "Bellsprout",
    species: [
      species({ id: 69, name: "Bellsprout", nameEn: "Bellsprout", minLevel: 1, maxLevel: 20 }),
      species({ id: 70, name: "Weepinbell", nameEn: "Weepinbell", minLevel: 21, maxLevel: 98 }),
      species({ id: 71, name: "Victreebel", nameEn: "Victreebel", minLevel: 99 }),
    ],
  },
  {
    id: "abra",
    name: "Abra",
    species: [
      species({ id: 63, name: "Abra", nameEn: "Abra", minLevel: 1, maxLevel: 15 }),
      species({ id: 64, name: "Kadabra", nameEn: "Kadabra", minLevel: 16, maxLevel: 98 }),
      species({ id: 65, name: "Alakazam", nameEn: "Alakazam", minLevel: 99 }),
    ],
  },
  {
    id: "meowth",
    name: "Meowth",
    species: [
      species({ id: 52, name: "Meowth", nameEn: "Meowth", minLevel: 1, maxLevel: 27 }),
      species({ id: 53, name: "Persian", nameEn: "Persian", minLevel: 28 }),
    ],
  },
  {
    id: "diglett",
    name: "Diglett",
    species: [
      species({ id: 50, name: "Diglett", nameEn: "Diglett", minLevel: 1, maxLevel: 25 }),
      species({ id: 51, name: "Dugtrio", nameEn: "Dugtrio", minLevel: 26 }),
    ],
  },
  {
    id: "drowzee",
    name: "Drowzee",
    species: [
      species({ id: 96, name: "Drowzee", nameEn: "Drowzee", minLevel: 1, maxLevel: 25 }),
      species({ id: 97, name: "Hypno", nameEn: "Hypno", minLevel: 26 }),
    ],
  },
  {
    id: "machop",
    name: "Machop",
    species: [
      species({ id: 66, name: "Machop", nameEn: "Machop", minLevel: 1, maxLevel: 27 }),
      species({ id: 67, name: "Machoke", nameEn: "Machoke", minLevel: 28, maxLevel: 98 }),
      species({ id: 68, name: "Machamp", nameEn: "Machamp", minLevel: 99 }),
    ],
  },
  {
    id: "onix",
    name: "Onix",
    species: [
      species({ id: 95, name: "Onix", nameEn: "Onix", minLevel: 1 }),
    ],
  },
  {
    id: "growlithe",
    name: "Growlithe",
    species: [
      species({ id: 58, name: "Growlithe", nameEn: "Growlithe", minLevel: 1, maxLevel: 98 }),
      species({ id: 59, name: "Arcanine", nameEn: "Arcanine", minLevel: 99 }),
    ],
  },
  {
    id: "vulpix",
    name: "Vulpix",
    species: [
      species({ id: 37, name: "Vulpix", nameEn: "Vulpix", minLevel: 1, maxLevel: 98 }),
      species({ id: 38, name: "Ninetales", nameEn: "Ninetales", minLevel: 99 }),
    ],
  },
  {
    id: "gastly",
    name: "Gastly",
    species: [
      species({ id: 92, name: "Gastly", nameEn: "Gastly", minLevel: 1, maxLevel: 24 }),
      species({ id: 93, name: "Haunter", nameEn: "Haunter", minLevel: 25, maxLevel: 98 }),
      species({ id: 94, name: "Gengar", nameEn: "Gengar", minLevel: 99 }),
    ],
  },
  {
    id: "cubone",
    name: "Cubone",
    species: [
      species({ id: 104, name: "Cubone", nameEn: "Cubone", minLevel: 1, maxLevel: 27 }),
      species({ id: 105, name: "Marowak", nameEn: "Marowak", minLevel: 28 }),
    ],
  },
  {
    id: "voltorb",
    name: "Voltorb",
    species: [
      species({ id: 100, name: "Voltorb", nameEn: "Voltorb", minLevel: 1, maxLevel: 29 }),
      species({ id: 101, name: "Electrode", nameEn: "Electrode", minLevel: 30 }),
    ],
  },
  {
    id: "magnemite",
    name: "Magnemite",
    species: [
      species({ id: 81, name: "Magnemite", nameEn: "Magnemite", minLevel: 1, maxLevel: 29 }),
      species({ id: 82, name: "Magneton", nameEn: "Magneton", minLevel: 30 }),
    ],
  },
  {
    id: "venonat",
    name: "Venonat",
    species: [
      species({ id: 48, name: "Venonat", nameEn: "Venonat", minLevel: 1, maxLevel: 30 }),
      species({ id: 49, name: "Venomoth", nameEn: "Venomoth", minLevel: 31 }),
    ],
  },
  {
    id: "doduo",
    name: "Doduo",
    species: [
      species({ id: 84, name: "Doduo", nameEn: "Doduo", minLevel: 1, maxLevel: 30 }),
      species({ id: 85, name: "Dodrio", nameEn: "Dodrio", minLevel: 31 }),
    ],
  },
  {
    id: "rhyhorn",
    name: "Rhyhorn",
    species: [
      species({ id: 111, name: "Rhyhorn", nameEn: "Rhyhorn", minLevel: 1, maxLevel: 41 }),
      species({ id: 112, name: "Rhydon", nameEn: "Rhydon", minLevel: 42 }),
    ],
  },
  {
    id: "exeggcute",
    name: "Exeggcute",
    species: [
      species({ id: 102, name: "Exeggcute", nameEn: "Exeggcute", minLevel: 1, maxLevel: 98 }),
      species({ id: 103, name: "Exeggutor", nameEn: "Exeggutor", minLevel: 99 }),
    ],
  },
  {
    id: "chansey",
    name: "Chansey",
    species: [
      species({ id: 113, name: "Chansey", nameEn: "Chansey", minLevel: 1 }),
    ],
  },
  {
    id: "kangaskhan",
    name: "Kangaskhan",
    species: [
      species({ id: 115, name: "Kangaskhan", nameEn: "Kangaskhan", minLevel: 1 }),
    ],
  },
  {
    id: "tauros",
    name: "Tauros",
    species: [
      species({ id: 128, name: "Tauros", nameEn: "Tauros", minLevel: 1 }),
    ],
  },
  {
    id: "koffing",
    name: "Koffing",
    species: [
      species({ id: 109, name: "Koffing", nameEn: "Koffing", minLevel: 1, maxLevel: 34 }),
      species({ id: 110, name: "Weezing", nameEn: "Weezing", minLevel: 35 }),
    ],
  },
  {
    id: "grimer",
    name: "Grimer",
    species: [
      species({ id: 88, name: "Grimer", nameEn: "Grimer", minLevel: 1, maxLevel: 37 }),
      species({ id: 89, name: "Muk", nameEn: "Muk", minLevel: 38 }),
    ],
  },
  {
    id: "psyduck",
    name: "Psyduck",
    species: [
      species({ id: 54, name: "Psyduck", nameEn: "Psyduck", minLevel: 1, maxLevel: 32 }),
      species({ id: 55, name: "Golduck", nameEn: "Golduck", minLevel: 33 }),
    ],
  },
  {
    id: "slowpoke",
    name: "Slowpoke",
    species: [
      species({ id: 79, name: "Slowpoke", nameEn: "Slowpoke", minLevel: 1, maxLevel: 36 }),
      species({ id: 80, name: "Slowbro", nameEn: "Slowbro", minLevel: 37 }),
    ],
  },
  {
    id: "ditto",
    name: "Ditto",
    species: [
      species({ id: 132, name: "Ditto", nameEn: "Ditto", minLevel: 1 }),
    ],
  },
  {
    id: "wobbuffet",
