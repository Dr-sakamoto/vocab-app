...
const SPRITE_ROOT =
  "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/";

const crystalSprite = id => `${SPRITE_ROOT}/black-white/animated/${id}.gif`;
const goldSprite = id => `${SPRITE_ROOT}/black-white/animated/${id}.gif`;
...
export function normalizeMonsterCollection(collection, legacy = {}) {
  ...
  return { version: 1, activeId: partyIds[0] ?? activeId, partyIds, habitatVisits, professorTransfers, giftClaims, monsters };
}
