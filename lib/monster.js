...
export const MONSTER_LINES = [
  ...
  // 据え置き（アートはP3で差替予定のプレースホルダ）。名前のみ IP_STARTERS.md に反映。
  {
    ...
    name: "カタコト",
    species: [
      species({ id: 1, name: "カタコト", nameEn: "Dictling", minLevel: 1, maxLevel: 15 }),
      species({ id: 2, name: "オシャベリ", nameEn: "Diction", minLevel: 16, maxLevel: 31 }),
      species({ id: 3, name: "コトダマ", nameEn: "Dictarch", minLevel: 32 }),
    ],
  },
  {
    // AUD 系：聞く／音
    ...
    name: "ミミタテ",
    species: [
      species({ id: 4, name: "ミミタテ", nameEn: "Audling", minLevel: 1, maxLevel: 15 }),
      species({ id: 5, name: "キキミミ", nameEn: "Audine", minLevel: 16, maxLevel: 35 }),
      species({ id: 6, name: "ジゴクミミ", nameEn: "Audarch", minLevel: 36 }),
    ],
  },
  {
    // SPEC 系：見る／まなざし
    ...
    name: "マナコ",
    species: [
      species({ id: 7, name: "マナコ", nameEn: "Speculet", minLevel: 1, maxLevel: 15 }),
      species({ id: 8, name: "ミハリ", nameEn: "Inspex", minLevel: 16, maxLevel: 35 }),
      species({ id: 9, name: "ミトオシ", nameEn: "Spectarch", minLevel: 36 }),
    ],
  },
  {
    id: "caterpie",
    name: "モゾ",
    species: [
      species({ id: 10, name: "モゾ", nameEn: "Mutalet", minLevel: 1, maxLevel: 6 }),
      species({ id: 11, name: "マユ", nameEn: "Mutex", minLevel: 7, maxLevel: 9 }),
      species({ id: 12, name: "アゲハ", nameEn: "Mutarch", minLevel: 10 }),
    ],
  },
  {
    id: "weedle",
    name: "チク",
    species: [
      species({ id: 13, name: "チク", nameEn: "Punctlet", minLevel: 1, maxLevel: 6 }),
      species({ id: 14, name: "サナギ", nameEn: "Punctine", minLevel: 7, maxLevel: 9 }),
      species({ id: 15, name: "ドクバリ", nameEn: "Punctarch", minLevel: 10 }),
    ],
  },
  {
    id: "pidgey",
    name: "ピヨ",
    species: [
      species({ id: 16, name: "ピヨ", nameEn: "Volalet", minLevel: 1, maxLevel: 17 }),
      species({ id: 17, name: "ハバタ", nameEn: "Volant", minLevel: 18, maxLevel: 35 }),
      species({ id: 18, name: "ソラヌシ", nameEn: "Volarch", minLevel: 36 }),
    ],
  },
  {
    id: "rattata",
    name: "カジリ",
    species: [
      species({ id: 19, name: "カジリ", nameEn: "Rodling", minLevel: 1, maxLevel: 19 }),
      species({ id: 20, name: "オオネズ", nameEn: "Rodarch", minLevel: 20 }),
    ],
  },
  {
    id: "spearow",
    name: "ツンドリ",
    species: [
      species({ id: 21, name: "ツンドリ", nameEn: "Pennling", minLevel: 1, maxLevel: 19 }),
      species({ id: 22, name: "オニドリ", nameEn: "Pennarch", minLevel: 20 }),
    ],
  },
  {
    id: "ekans",
    name: "ニョロ",
    species: [
      species({ id: 23, name: "ニョロ", nameEn: "Serpling", minLevel: 1, maxLevel: 21 }),
      species({ id: 24, name: "ウワバミ", nameEn: "Serparch", minLevel: 22 }),
    ],
  },
  {
    id: "pikachu",
    name: "バチ",
    species: [
      species({ id: 25, name: "バチ", nameEn: "Fulglet", minLevel: 1, maxLevel: 98 }),
      species({ id: 26, name: "カミナリ", nameEn: "Fulgarch", minLevel: 99 }),
    ],
  },
  {
    id: "sandshrew",
    name: "スナマル",
    species: [
      species({ id: 27, name: "スナマル", nameEn: "Terrling", minLevel: 1, maxLevel: 21 }),
      species({ id: 28, name: "イワヨロイ", nameEn: "Terrarch", minLevel: 22 }),
    ],
  },
  {
    id: "nidoran-f",
    name: "ツノヒメ",
    species: [
      species({ id: 29, name: "ツノヒメ", nameEn: "Regnling", minLevel: 1, maxLevel: 15 }),
      species({ id: 30, name: "ドクヒメ", nameEn: "Regnine", minLevel: 16, maxLevel: 98 }),
      species({ id: 31, name: "キサキ", nameEn: "Regnarch", minLevel: 99 }),
    ],
  },
  {
    id: "nidoran-m",
    name: "ツノボウ",
    species: [
      species({ id: 32, name: "ツノボウ", nameEn: "Domling", minLevel: 1, maxLevel: 15 }),
      species({ id: 33, name: "ドクボウ", nameEn: "Domine", minLevel: 16, maxLevel: 98 }),
      species({ id: 34, name: "オオキミ", nameEn: "Domarch", minLevel: 99 }),
    ],
  },
  {
    id: "clefairy",
  ...
  },
  {
    ...
    species: [
      ...
      species({ id: 65, name: "センリガン", nameEn: "Mirarch", minLevel: 99 }),
    ],
  },
  {
    id: "machop",
  ...
  },
  {
    ...
    name: "ネギガモ",
    species: [
      species({ id: 83, name: "ネギガモ", nameEn: "Rarix", minLevel: 1 }),
    ],
  },
  {
    id: "doduo",
  ...
  },
  {
    ...
    name: "イワダイジャ",
    species: [
      species({ id: 95, name: "イワダイジャ", nameEn: "Lithix", minLevel: 1 }),
    ],
  },
  {
    id: "drowzee",
  ...
  },
  {
    ...
    name: "ケリンボ",
    species: [
      species({ id: 106, name: "ケリンボ", nameEn: "Pedix", minLevel: 1 }),
    ],
  },
  {
    id: "hitmonchan",
    name: "コブシロー",
    species: [
      species({ id: 107, name: "コブシロー", nameEn: "Pugnix", minLevel: 1 }),
    ],
  },
  {
    id: "lickitung",
    name: "ベロロン",
    species: [
      species({ id: 108, name: "ベロロン", nameEn: "Linguix", minLevel: 1 }),
    ],
  },
  {
    id: "koffing",
  ...
  },
  {
    ...
    name: "ハピタマ",
    species: [
      species({ id: 113, name: "ハピタマ", nameEn: "Sanix", minLevel: 1 }),
    ],
  },
  {
    id: "tangela",
    name: "ツタモジャ",
    species: [
      species({ id: 114, name: "ツタモジャ", nameEn: "Nexix", minLevel: 1 }),
    ],
  },
  {
    id: "kangaskhan",
    name: "オヤコ",
    species: [
      species({ id: 115, name: "オヤコ", nameEn: "Matrix", minLevel: 1 }),
    ],
  },
  {
    id: "horsea",
  ...
  },
  {
    ...
    name: "マネンボ",
    species: [
      species({ id: 122, name: "マネンボ", nameEn: "Mimix", minLevel: 1 }),
    ],
  },
  {
    id: "scyther",
    name: "カマイタチ",
    species: [
      species({ id: 123, name: "カマイタチ", nameEn: "Sectix", minLevel: 1 }),
    ],
  },
  {
    id: "jynx",
    name: "オドリコ",
    species: [
      species({ id: 124, name: "オドリコ", nameEn: "Choreix", minLevel: 1 }),
    ],
  },
  {
    id: "electabuzz",
    name: "ビリンコ",
    species: [
      species({ id: 125, name: "ビリンコ", nameEn: "Scintix", minLevel: 1 }),
    ],
  },
  {
    id: "magmar",
