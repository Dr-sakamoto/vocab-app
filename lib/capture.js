...
import { createMonsterInstance, normalizeMonsterCollection, getXpForLevel, getSpecies } from "./monster.js";
...
export const HABITATS = [
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "zubat", rate: 49, },
      { lineId: "geodude", rate: 30, },
      { lineId: "paras", rate: 15, },
      { lineId: "clefairy", rate: 6, },
    ]),
  },
  {
    id: "route-4",
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "gastly", rate: 75 },
      { lineId: "cubone", rate: 15 },
      { lineId: "gastly", rate: 10 },
    ]),
  },
  {
    id: "route-10",
  ...
  },
  {
    ...
    [
      ...
      { lineId: "paras", rate: 15 },
      { lineId: "rhyhorn", rate: 20 },
      { lineId: "exeggcute", rate: 20 },
      { lineId: "doduo", rate: 5 },
      { lineId: "chansey", rate: 5 },
      { lineId: "kangaskhan", rate: 5 },
      { lineId: "tauros", rate: 5 },
      { lineId: "strike", rate: 5 },
    ],
    [
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "goldeen", rate: 25 },
      { lineId: "magikarp", rate: 35 },
      { lineId: "poliwag", rate: 15 },
      { lineId: "tentacool", rate: 10 },
      { lineId: "horsea", rate: 5 },
      { lineId: "krabby", rate: 5 }, // FR限定
    ]),
  },
  {
    id: "sea-routes-19-21",
  ...
  },
  {
    ...
    versionEncounters: both(
      [
        { lineId: "gyarados", rate: 15 },
        { lineId: "seaking", rate: 15 },
        { lineId: "poliwhirl", rate: 10 },
        { lineId: "kingler", rate: 10 },
        { lineId: "seadra", rate: 10 }, 
        { lineId: "tentacruel", rate: 10 }, 
        { lineId: "shellder", rate: 6 }, 
        { lineId: "staryu", rate: 6 }, 
        { lineId: "psyduck", rate: 6 },
        { lineId: "slowpoke", rate: 6 },
        { lineId: "poliwhirl", rate: 5 },
        { lineId: "dragonair", rate: 1 },
      ],
    ),
  },
];
...
export function normalizeVersionedEncounters(versionEncounters, habitatId = null) {
  ...
  for (const encounters of versions) {
    for (const encounter of encounters) {
      ...
      const key = `${encounter.lineId}:${minLevel}:${maxLevel}`;
