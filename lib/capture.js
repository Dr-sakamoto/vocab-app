...
export const HABITATS = [
  {
    ...
    versionEncounters: both([
      { lineId: "pidgey", rate: 50, minLevel: 2, maxLevel: 5 },
      { lineId: "rattata", rate: 50, minLevel: 2, maxLevel: 4 },
    ]),
  },
  {
    id: "route-22",
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "rattata", rate: 45, minLevel: 3, maxLevel: 5 },
      { lineId: "mankey", rate: 45, minLevel: 3, maxLevel: 5 },
      { lineId: "spearow", rate: 10, minLevel: 3, maxLevel: 5 },
    ]),
  },
  {
    id: "route-2",
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "pidgey", rate: 45, minLevel: 2, maxLevel: 5 },
      { lineId: "rattata", rate: 45, minLevel: 2, maxLevel: 4 },
      { lineId: "caterpie", rate: 5, minLevel: 1, maxLevel: 3 },
      { lineId: "weedle", rate: 5, minLevel: 1, maxLevel: 3 },
    ]),
  },
  {
    id: "viridian-forest",
    ...
    versionEncounters: split(
      [
        { lineId: "caterpie", rate: 40, minLevel: 3, maxLevel: 5 },
        { lineId: "weedle", rate: 40, minLevel: 3, maxLevel: 5 },
        { lineId: "caterpie", rate: 10, minLevel: 1, maxLevel: 3 },
        { lineId: "weedle", rate: 5, minLevel: 1, maxLevel: 3 },
        { lineId: "pikachu", rate: 5, minLevel: 3, maxLevel: 5 },
      ],
      [
        { lineId: "caterpie", rate: 40, minLevel: 3, maxLevel: 5 },
        { lineId: "weedle", rate: 40, minLevel: 3, maxLevel: 5 },
        { lineId: "caterpie", rate: 5, minLevel: 4, maxLevel: 4 },
        { lineId: "weedle", rate: 10, minLevel: 4, maxLevel: 6 },
        { lineId: "pikachu", rate: 5, minLevel: 3, maxLevel: 5 },
      ],
    ),
  },
  {
    ...
    versionEncounters: both([
      ...
      { lineId: "pidgey", rate: 30, minLevel: 2, maxLevel: 5 },
      { lineId: "jigglypuff", rate: 10, minLevel: 2, maxLevel: 5 },
      { lineId: "mankey", rate: 10, minLevel: 2, maxLevel: 5 },
      { lineId: "nidoran-f", rate: 10, minLevel: 2, maxLevel: 5 },
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "zubat", rate: 69, minLevel: 3, maxLevel: 5 },
  ...
  },
  {
    ...
    versionEncounters: split(
      [
        { lineId: "oddish", rate: 25, minLevel: 2, maxLevel: 5 },
        { lineId: "caterpie", rate: 20, minLevel: 2, maxLevel: 5 },
        { lineId: "weedle", rate: 20, minLevel: 2, maxLevel: 5 },
        { lineId: "pidgey", rate: 15, minLevel: 2, maxLevel: 5 },
        { lineId: "abra", rate: 15, minLevel: 2, maxLevel: 5 },
        { lineId: "weedle", rate: 4, minLevel: 2, maxLevel: 5 },
        { lineId: "caterpie", rate: 1, minLevel: 2, maxLevel: 5 },
      ],
      [
        { lineId: "bellsprout", rate: 25, minLevel: 2, maxLevel: 5 },
        { lineId: "caterpie", rate: 20, minLevel: 2, maxLevel: 5 },
        { lineId: "weedle", rate: 20, minLevel: 2, maxLevel: 5 },
        { lineId: "pidgey", rate: 15, minLevel: 2, maxLevel: 5 },
        { lineId: "abra", rate: 15, minLevel: 2, maxLevel: 5 },
        { lineId: "caterpie", rate: 4, minLevel: 2, maxLevel: 5 },
        { lineId: "weedle", rate: 1, minLevel: 2, maxLevel: 5 },
      ],
    ),
  },
  {
  ...
  },
  {
    ...
    versionEncounters: split(
      [
        { lineId: "pidgey", rate: 40, minLevel: 2, maxLevel: 5 },
        { lineId: "meowth", rate: 25, minLevel: 2, maxLevel: 5 },
        { lineId: "oddish", rate: 25, minLevel: 2, maxLevel: 5 },
        { lineId: "mankey", rate: 10, minLevel: 2, maxLevel: 5 },
      ],
      [
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { lineId: "diglett", rate: 95, minLevel: 2, maxLevel: 5 },
      { lineId: "diglett", rate: 5, minLevel: 2, maxLevel: 5 },
    ]),
  },
  {
    id: "route-11",
...
export function normalizeVersionedEncounters(versionEncounters, habitatId = null) {
  ...
  for (const encounters of versions) {
    for (const encounter of encounters) {
      ...
      const current = byLine.get(encounter.lineId);
      const weight = rate / versions.length;

      // lineIdでマージせず、レベル情報を保持したまま配列に追加
      byLine.set(encounter.lineId, {
        lineId: encounter.lineId,
        weight: rate / versions.length, // バージョン数で割ることで全体の確率の帳尻を合わせる
        minLevel: Math.min(current?.minLevel ?? minLevel, minLevel),
        maxLevel: Math.max(current?.maxLevel ?? maxLevel, maxLevel),
      });
      byLine.get(encounter.lineId).weight = (current?.weight ?? 0) + weight;
    }
  }
