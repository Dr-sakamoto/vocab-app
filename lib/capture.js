...
import { createMonsterInstance, normalizeMonsterCollection, getXpForLevel, getSpecies, getLineIdBySpeciesId } from "./monster.js";
...
export const HABITATS = [
  ...
  },
  {
    ...
    versionEncounters: split(
      [
        { speciesId: 10, minLevel: 3, maxLevel: 5,  rate: 50 }, // キャタピー (FR)
        { speciesId: 13, minLevel: 3, maxLevel: 5,  rate: 45 }, // ビードル (FR)
        { speciesId: 25, minLevel: 3, maxLevel: 5,  rate:  5 }, // ピカチュウ
      ],
      [
        { speciesId: 10, minLevel: 3, maxLevel: 5,  rate: 45 }, // キャタピー (LG)
        { speciesId: 13, minLevel: 3, maxLevel: 5,  rate: 50 }, // ビードル (LG)
        { speciesId: 25, minLevel: 3, maxLevel: 5,  rate:  5 }, // ピカチュウ
      ],
    ),
  },
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { speciesId: 92, minLevel: 13, maxLevel: 19, rate: 85 }, // ゴース
      { speciesId: 104, minLevel: 15, maxLevel: 19, rate: 15 }, // カラカラ
    ]),
  },
  {
    id: "route-10",
  ...
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { speciesId: 81,  minLevel: 22, maxLevel: 34, rate: 40 }, // コイル
      { speciesId: 100, minLevel: 22, maxLevel: 25, rate: 30 }, // ビリリダマ
      { speciesId: 25,  minLevel: 22, maxLevel: 26, rate: 25 }, // ピカチュウ
  ...
  },
  {
    ...
    versionEncounters: split(
      [
        { speciesId: 43, minLevel: 22, maxLevel: 30, rate: 30 }, // ナゾノクサ (FR)
        { speciesId: 48, minLevel: 24, maxLevel: 26, rate: 30 }, // コンパン
        { speciesId: 16, minLevel: 23, maxLevel: 29, rate: 40 }, // ポッポ
      ],
      [
        { speciesId: 69, minLevel: 22, maxLevel: 30, rate: 30 }, // マダツボミ (LG)
        { speciesId: 48, minLevel: 24, maxLevel: 26, rate: 30 }, // コンパン
        { speciesId: 16, minLevel: 23, maxLevel: 29, rate: 40 }, // ポッポ
      ],
    ),
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { speciesId: 21, minLevel: 20, maxLevel: 29, rate: 30 }, // オニスズメ
      { speciesId: 84, minLevel: 18, maxLevel: 28, rate: 30 }, // ドードー
      { speciesId: 19, minLevel: 18, maxLevel: 29, rate: 40 }, // コラッタ
    ]),
  },
  {
    id: "safari-zone",
  ...
  },
  {
    ...
    versionEncounters: split(
      [
        { speciesId: 19,  minLevel: 26, maxLevel: 38, rate: 50 }, // コラッタ
        { speciesId: 109, minLevel: 28, maxLevel: 30, rate: 40 }, // ドガース (FR)
        { speciesId: 58,  minLevel: 30, maxLevel: 32, rate: 10 }, // ガーディ (FR)
      ],
      [
        { speciesId: 19,  minLevel: 26, maxLevel: 38, rate: 50 }, // コラッタ
        { speciesId: 88,  minLevel: 28, maxLevel: 30, rate: 40 }, // ベトベター (LG)
        { speciesId: 37,  minLevel: 30, maxLevel: 32, rate: 10 }, // ロコン (LG)
      ],
    ),
  },
  {
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { speciesId: 41, minLevel: 22, maxLevel: 30, rate: 50 }, // ズバット
      { speciesId: 54, minLevel: 26, maxLevel: 33, rate: 25 }, // コダック
      { speciesId: 79, minLevel: 26, maxLevel: 33, rate: 25 }, // ヤドン
    ]),
  },
  {
    id: "victory-road",
    ...
    encounterRule: "frlg-version-average",
    versionEncounters: both([
      { speciesId: 66, minLevel: 32, maxLevel: 48, rate: 45 }, // ワンリキー
      { speciesId: 74, minLevel: 32, maxLevel: 34, rate: 40 }, // イシツブテ
      { speciesId: 95, minLevel: 40, maxLevel: 48, rate: 15 }, // イワーク
    ]),
  },
  {
    id: "cerulean-cave",
    ...
    versionEncounters: both([
      ...
      { speciesId: 113, minLevel: 46, maxLevel: 67, rate:  5 }, // ラッキー
      { speciesId: 202, minLevel: 55, maxLevel: 61, rate:  5 }, // ソーナンス
    ]),
  },
  {
    id: "old-rod",
...
export function normalizeVersionedEncounters(versionEncounters) {
  ...
  for (const encounters of versions) {
    for (const encounter of encounters) {
      ...
      if (!encounter.speciesId || !Number.isFinite(rate) || rate <= 0) continue;

      const minLevel = encounter.minLevel ?? 1;
      const maxLevel = encounter.maxLevel ?? minLevel;
      const key = `${encounter.speciesId}:${minLevel}:${maxLevel}`;
      ...
      if (current) {
        ...
        merged.set(key, {
          ...
          lineId: getLineIdBySpeciesId(encounter.speciesId),
