...
瞬間英作文（日本語→英文・英文→和訳をAIが添削採点し、文法の弱点から出題する）は
別リポジトリ [Flash-English-Sentence](https://github.com/Dr-sakamoto/Flash-English-Sentence)
にある。デザイントークン・AI判定の作法・分散学習の間隔はこのリポジトリから流用している。
